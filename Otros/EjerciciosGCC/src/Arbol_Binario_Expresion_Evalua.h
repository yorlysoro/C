#ifndef ARBOL_BINARIO_EXPRESION_EVALUA_H_INCLUDED
#define ARBOL_BINARIO_EXPRESION_EVALUA_H_INCLUDED
...
int FnIntArbolBinarioExpresionEvalua(nodo_arbol *pNodo)
{
    ...
    {
    	xValorIzquierdo = FnIntArbolBinarioExpresionEvalua(pNodo->pIzquierdo);
    	xValorDerecho = FnIntArbolBinarioExpresionEvalua(pNodo->pDerecho);
...
#endif // ARBOL_BINARIO_EXPRESION_EVALUA_H_INCLUDED
